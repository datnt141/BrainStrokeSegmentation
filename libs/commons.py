...
class SupFns:
    ...
    def imresize(cls, i_image=None, i_tsize=(512,512),i_min=None,i_max=None):
        ...
        image = np.array(Image.fromarray(np.squeeze(image)).resize(i_tsize))
        ...
        return image
    @classmethod
    def scale_mask(cls,i_mask=None,i_tsize=None):#Remove i_num_labels later as it affect to some of other files.
...
if __name__ == '__main__':
    print('This module provide support fuctions')
"""=================================================================================================================="""