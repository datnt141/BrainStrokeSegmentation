...
class StackedCnnUNets:
    ...
    def train(self,i_train_db=None,i_val_db=None):
        ...
        self.clsnet.eval(i_db=cls_val_db.batch(self.clsnet.vbatch_size))
        ...
        self.segnet.eval(i_db=seg_val_db.batch(self.segnet.vbatch_size))
    ...
    def get_obj_blks(cls,i_image=None,i_mask=None,i_blk_sizes=None,i_object_size=10000):
        ...
        blocks, masks   = cls.get_blks(i_image=i_image,i_mask=i_mask,i_blk_sizes=i_blk_sizes,i_blk_strides=(32,32))
