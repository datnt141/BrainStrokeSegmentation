...
if __name__ == '__main__':
    ...
    StackedCnnUNets.vcls_isize       = (32, 32)   # Size of block for clsnet                                     (*)
    StackedCnnUNets.vseg_isize       = (32, 32)   # Size ò block for segnet                                      (*)
    StackedCnnUNets.vcls_strides     = (16, 16)   # Stride for taking blocks for clsnet                          (*)
    StackedCnnUNets.vseg_strides     = (16, 16)   # Stride for taking blocks for segnet                          (*)
