...
if __name__ == '__main__':
    ...
    seg_params.vdb_repeat                = 3             # Repeat dataset at single learing rate    (Fixed)
    ...
    StackedCnnUNets.vcls_object_size = 1000       # Threshold for deciding blocks with/without gnd object        (Fixed)
    StackedCnnUNets.vseg_object_size = 1000       # Threshold for deciding blocks with/without gnd object        (Fixed)
