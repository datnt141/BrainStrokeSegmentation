...
if __name__ == '__main__':
    ...
    StackedCnnUNets.vcls_object_size = 1e10       # Threshold for deciding blocks with/without gnd object        (Fixed)
    StackedCnnUNets.vseg_object_size = 1e10       # Threshold for deciding blocks with/without gnd object        (Fixed)
