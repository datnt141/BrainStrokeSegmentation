...
if __name__ == '__main__':
    ...
    cls_params.vmodel_name     = 'cCNN_MS_tiny'  # Model name     cCNN_tiny_tiny            cCNN_MS_tiny            (*)
    ...
    StackedCnnUNets.vcls_isize       = (128, 128) # Size of block for clsnet                                     (*)
    ...
    StackedCnnUNets.vcls_sgray_level = 0          # Threshold for removing dark blocks                           (Fixed)
